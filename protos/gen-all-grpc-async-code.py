...
if __name__ == '__main__':
    ...
    os.system('protos/generate-grpc-async-code.py ' + '-i ' + proto_file + ' -ph ' + generated_proto_path + '/' +
                  file + '.pb.h ' + '-gh ' + generated_proto_path + '/' +
                  file + '.grpc.pb.h ' + '-oh ' + output_header_path + '/' +
                  file + 'Server' + '.hpp ' + '-os ' + output_source_path +
                  '/' + file + 'Server' + '.cpp ' + '-ht ' + output_template_path + '/' +
                  'unary_server_tmp.hpp ' + '-st ' + output_template_path + '/' +
